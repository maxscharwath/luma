...
`transmission` on enable and unregisters it on disable, so toggling it adds or
removes Transmission from the download-client picker. `dependsOn` the Downloads
